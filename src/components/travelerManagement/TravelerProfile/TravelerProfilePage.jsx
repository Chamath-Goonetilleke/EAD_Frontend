/*
------------------------------------------------------------------------------
File: TravelerProfilePage.js
Purpose: This file contains the TravelerProfilePage React component, which
displays and manages the traveler's profile and related functionalities.
Author: IT20122096
Date: 2023-10-13
------------------------------------------------------------------------------
*/
                ...
                <div>
                  <div style={{ fontSize: "18px", flex: 2 }}>
                    ...
                    >
                      ...
                      {role === "BackOfficeUser" && traveler.state === 1 ? (
                        <Button
                          variant="outlined"
                          size="small"
